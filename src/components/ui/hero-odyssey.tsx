...
const Lightning: React.FC<LightningProps> = ({
    ...
    // Use a ref to store current props so the render loop can access them
    // without triggering a re-init of the WebGL context/program.
    ...
    useEffect(() => {
        ...
        const resizeCanvas = () => {
            // Check if client dimensions have changed to avoid unnecessary resizes
    ...
    `;
        ...
        const render = () => {
            resizeCanvas(); // Will only resize if dimensions changed
            gl.viewport(0, 0, canvas.width, canvas.height); // Update viewport if size changed

            // Use values from propsRef
        ...
        <div className="relative w-full bg-black text-white overflow-hidden">
            ...
            <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 h-screen">
                ...
                >
                    ...
                    >
                        We specialize in connecting businesses with the right workforce to drive success and growth.
                    </motion.p>
                    <motion.button
                        variants={itemVariants}
                        whileHover={{ scale: 1.05 }}
